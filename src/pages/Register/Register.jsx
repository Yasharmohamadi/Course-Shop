					...
					<form className="register_from">
						...
						<div className="input_wrapper">
							...
							<svg viewBox="0 0 576 512">
								<path
									fill={formState.inputs.registerFullName.isValid ? '#00e000b4' : '#ffffff41'}
						...
						<div className="input_wrapper">
							...
							>
								<path
									fill={formState.inputs.registerUsername.isValid ? '#00e000b4' : '#ffffff41'}
						...
						<div className="input_wrapper">
							...
							>
								<path
									fill={formState.inputs.registerEmail.isValid ? '#00e000b4' : '#ffffff41'}
						...
						<div className="input_wrapper">
							...
							>
								<path
									fill={formState.inputs.registerPassword.isValid ? '#00e000b4' : '#ffffff41'}
