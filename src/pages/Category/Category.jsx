			...
			<div className="container">
				<div className="category-header">
					<div className="category-header_filterbox">
						<div className="category-header_row-btn">
							<svg
								class="svg-inline--fa fa-border-all"
								aria-hidden="true"
								focusable="false"
								data-prefix="fas"
						...
						<div className="category-header_column-btn">
							<svg
						...
						<div className="category-header_selection">
							<span className="category-header_selection-text">
								مرتب سازی پیش فرض
				...
				<div class="row category-courses">
